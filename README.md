...
[METHODOLOGY.md](https://github.com/jman4162/athletevalue/blob/main/METHODOLOGY.md) gives the equations, estimates and caveats for each layer.
...
See [CONTRIBUTING.md](https://github.com/jman4162/athletevalue/blob/main/CONTRIBUTING.md). Sourced deals for the registry are the most
